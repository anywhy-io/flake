...
<img alt="Ergonomic positioning of a split keyboard" width="100%" src="./img/table.jpg">
...
<img alt="Comparison of row stagger and column stagger" width="100%" src="./img/col_stagger.svg">
...
<img alt="Flake keyboard showing both MX and Choc switches" width="100%" src="./img/flake_switches.jpg">
...
<img alt="Visual representation of keyboard layers in ZMK" width="100%" src="./img/config.svg">
...
<img alt="Flake L keyboard" width="100%" src="./img/flake-l.jpg">
...
<img alt="Side profile showing the thinness of the Flake keyboard" width="100%" src="./img/thickness.jpg">

## Build Your Own Flake

Ready to build one? The comprehensive build guide has everything you need to get started.
➡️ **[Read the Official Build Guide](./build_guide.md)**
